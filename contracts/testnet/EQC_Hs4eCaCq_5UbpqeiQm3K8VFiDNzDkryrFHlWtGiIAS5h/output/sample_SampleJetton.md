...
## SendEnoughJetton
TLB: `send_enough_jetton#8b771736 query_id:uint64 minter:address response_destination:Maybe address forward_ton_amount:coins forward_payload:remainder<slice> = SendEnoughJetton`
Signature: `SendEnoughJetton{query_id:uint64,minter:address,response_destination:Maybe address,forward_ton_amount:coins,forward_payload:remainder<slice>}`
