...
Signature: `VaultUpdateContent{name:^string,symbol:^string,decimals:Maybe int257}`
...
Signature: `NewVault{asset:address,name:^string,symbol:^string}`

## VaultCreated
TLB: `vault_created#878baf8a owner:address asset:address address:address = VaultCreated`
Signature: `VaultCreated{owner:address,asset:address,address:address}`
