...
function dictValueParserLuckyMint(): DictionaryValue<LuckyMint> {
 ...
 type LuckyWallet_init_args = {
    $$type: 'LuckyWallet_init_args';
    collection_address: Address;
    item_index: bigint;
}

function initLuckyWallet_init_args(src: LuckyWallet_init_args) {
    return (builder: Builder) => {
        let b_0 = builder;
        b_0.storeAddress(src.collection_address);
...
async function LuckyWallet_init(collection_address: Address, item_index: bigint) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
    let builder = beginCell();
    builder.storeRef(__system);
    builder.storeUint(0, 1);
    initLuckyWallet_init_args({ $$type: 'LuckyWallet_init_args', collection_address, item_index })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const LuckyWallet_errors: { [key: number]: { message: string } } = {
...
const LuckyWallet_types: ABIType[] = [
...
const LuckyWallet_getters: ABIGetter[] = [
    {"name":"get_nft_data","arguments":[],"returnType":{"kind":"simple","type":"GetNftData","optional":false}},
    {"name":"lucky","arguments":[],"returnType":{"kind":"simple","type":"bool","optional":false}},
]

const LuckyWallet_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"empty"}},
    {"receiver":"internal","message":{"kind":"any"}},
    {"receiver":"internal","message":{"kind":"text"}},
    {"receiver":"internal","message":{"kind":"typed","type":"LuckySend"}},
    {"receiver":"internal","message":{"kind":"typed","type":"Transfer"}},
    {"receiver":"internal","message":{"kind":"typed","type":"GetStaticData"}},
]

export class LuckyWallet implements Contract {
    
    static async init(collection_address: Address, item_index: bigint) {
        return await LuckyWallet_init(collection_address, item_index);
    }
    
    static async fromInit(collection_address: Address, item_index: bigint) {
        const init = await LuckyWallet_init(collection_address, item_index);
        const address = contractAddress(0, init);
        return new LuckyWallet(address, init);
    }
    
    static fromAddress(address: Address) {
        return new LuckyWallet(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  LuckyWallet_types,
        getters: LuckyWallet_getters,
        receivers: LuckyWallet_receivers,
        errors: LuckyWallet_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: null | Slice | string | LuckySend | Transfer | GetStaticData) {
        ...
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'LuckySend') {
            body = beginCell().store(storeLuckySend(message)).endCell();
        }
    ...
    async getLucky(provider: ContractProvider) {
        let builder = new TupleBuilder();
        let source = (await provider.get('lucky', builder.build())).stack;
