...
function dictValueParserAdd(): DictionaryValue<Add> {
 ...
 type FactoryContract_init_args = {
    $$type: 'FactoryContract_init_args';
    owner: Address;
}

function initFactoryContract_init_args(src: FactoryContract_init_args) {
    return (builder: Builder) => {
        let b_0 = builder;
...
const FactoryContract_types: ABIType[] = [
...
const FactoryContract_getters: ABIGetter[] = [
    {"name":"counter","arguments":[],"returnType":{"kind":"simple","type":"int","optional":false,"format":257}},
]

const FactoryContract_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"typed","type":"Add"}},
    {"receiver":"internal","message":{"kind":"text","text":"increment"}},
    {"receiver":"internal","message":{"kind":"typed","type":"Deploy"}},
]

export class FactoryContract implements Contract {
    
    static async init(owner: Address) {
        return await FactoryContract_init(owner);
    }
    
    static async fromInit(owner: Address) {
        const init = await FactoryContract_init(owner);
        const address = contractAddress(0, init);
        return new FactoryContract(address, init);
    }
    
    static fromAddress(address: Address) {
        return new FactoryContract(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  FactoryContract_types,
        getters: FactoryContract_getters,
        receivers: FactoryContract_receivers,
        errors: FactoryContract_errors,
    };
