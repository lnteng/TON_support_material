...
export function storeHTLC(src: HTLC) {
    return (builder: Builder) => {
        let b_0 = builder;
        b_0.storeInt(src.hashlock, 256);
        b_0.storeInt(src.secret, 256);
        b_0.storeCoins(src.amount);
        b_0.storeUint(src.timelock, 256);
        let b_1 = new Builder();
...
export function loadHTLC(slice: Slice) {
    let sc_0 = slice;
    let _hashlock = sc_0.loadIntBig(256);
    let _secret = sc_0.loadIntBig(256);
    let _amount = sc_0.loadCoins();
    let _timelock = sc_0.loadUintBig(256);
...
export function storeTonTransferInitiated(src: TonTransferInitiated) {
    return (builder: Builder) => {
        let b_0 = builder;
        b_0.storeInt(src.__hashlock, 256);
        b_0.storeCoins(src.__amount);
        b_0.storeInt(src.__chainId, 256);
        b_0.storeInt(src.__timelock, 256);
        let b_1 = new Builder();
...
export function loadTonTransferInitiated(slice: Slice) {
    let sc_0 = slice;
    let ___hashlock = sc_0.loadIntBig(256);
    let ___amount = sc_0.loadCoins();
    let ___chainId = sc_0.loadIntBig(256);
    let ___timelock = sc_0.loadIntBig(256);
    let sc_1 = sc_0.loadRef().beginParse();
...
export function loadCreate(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 501618384) { throw Error('Invalid prefix'); }
...
export function loadRedeem(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 1940771006) { throw Error('Invalid prefix'); }
...
export function loadRefund(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 2850019230) { throw Error('Invalid prefix'); }
...
async function HashedTimeLockTON_init() {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
...
const HashedTimeLockTON_types: ABIType[] = [
    ...
    {"name":"HTLC","header":null,"fields":[{"name":"hashlock","type":{"kind":"simple","type":"int","optional":false,"format":256}},{"name":"secret","type":{"kind":"simple","type":"int","optional":false,"format":256}},{"name":"amount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"timelock","type":{"kind":"simple","type":"uint","optional":false,"format":256}},{"name":"sender","type":{"kind":"simple","type":"address","optional":false}},{"name":"_receiver","type":{"kind":"simple","type":"address","optional":false}},{"name":"redeemed","type":{"kind":"simple","type":"bool","optional":false}},{"name":"refunded","type":{"kind":"simple","type":"bool","optional":false}}]},
    {"name":"TonTransferInitiated","header":null,"fields":[{"name":"__hashlock","type":{"kind":"simple","type":"int","optional":false,"format":256}},{"name":"__amount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"__chainId","type":{"kind":"simple","type":"int","optional":false,"format":256}},{"name":"__timelock","type":{"kind":"simple","type":"int","optional":false,"format":256}},{"name":"__sender","type":{"kind":"simple","type":"address","optional":false}},{"name":"__receiver","type":{"kind":"simple","type":"address","optional":false}},{"name":"__targetCurrencyReceiverAddress","type":{"kind":"simple","type":"string","optional":false}}]},
    {"name":"Create","header":501618384,"fields":[{"name":"data","type":{"kind":"simple","type":"TonTransferInitiated","optional":false}}]},
    {"name":"TonTransferClaimed","header":null,"fields":[{"name":"__hashlock","type":{"kind":"simple","type":"int","optional":false,"format":256}},{"name":"__receiver","type":{"kind":"simple","type":"address","optional":false}},{"name":"__amount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}}]},
    {"name":"Redeem","header":1940771006,"fields":[{"name":"data","type":{"kind":"simple","type":"TonTransferClaimed","optional":false}}]},
    {"name":"TonTransferRefunded","header":null,"fields":[{"name":"__hashlock","type":{"kind":"simple","type":"int","optional":false,"format":256}},{"name":"__receiver","type":{"kind":"simple","type":"address","optional":false}},{"name":"__amount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}}]},
    {"name":"Refund","header":2850019230,"fields":[{"name":"data","type":{"kind":"simple","type":"TonTransferRefunded","optional":false}}]},
]
